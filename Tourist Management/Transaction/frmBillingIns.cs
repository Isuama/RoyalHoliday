...
{
    public partial class frmBillingIns : Form
    {
        private const string msghd = "Billing Instructions Setup";
        public string SqlQry = "SELECT Instruc,IsActive From mst_BillingIns Order By SrNo";
        public int Mode = 0,SystemCode = 0; // TO KEEP THE SYSTEM GENERATED CODE
        Boolean bLoad = false;
        enum CC { gEAD, gIAT };
        public frmBillingIns(){InitializeComponent();}
        private void frmBillingIns_Load(object sender, EventArgs e)
        {
            Intializer();
        }
        ...
        private void Fill_Data()
        {
            try
            {
                ...
                string ssql; 
                int RowNumb;
                ssql = "SELECT Instruc,IsActive From mst_BillingIns Order By SrNo";
        ...
        private Boolean Save_CCEmails(System.Data.SqlClient.SqlCommand sqlCom)
        {
            ...
            Boolean RtnVal = true;
                ...
                sqlCom.CommandText = "spSave_mst_BillingIns";
                RowNumb = 1;
